...
class GuardrailEngineResult(BaseModel):
    ...
    is_novel: Optional[bool] = Field(default=None, description="Whether the case is novel (None=unknown)")
    has_conflict: Optional[bool] = Field(
        default=None, description="Whether evidence conflicts exist (None=unknown)"
    )
